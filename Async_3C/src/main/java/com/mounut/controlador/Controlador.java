...
import com.mounut.config.Fecha;
...
public class Controlador extends HttpServlet {
    ...
    DisenadorDAO mardao = new DisenadorDAO();
    ...
    private void guardarMarca(HttpServletRequest request, HttpServletResponse response) {
        if (request.getParameter("txtmar") != null) {
            m.setDisenador(request.getParameter("txtmar"));
            if (request.getParameter("chkestado") != null) {
                m.setEstado(true);
            } else {
                m.setEstado(false);
    ...
    private void actualizarMrca(HttpServletRequest request, HttpServletResponse response) {
