        ...
        <nav class="navbar navbar-expand-lg navbar-light margin-bottom">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="./Controlador?accion=home"><i class="fas fa-undo"></i> Seguir Comprando</a>
                    </li>                  
                </ul>                                            
                ...
                <div class="col-lg-3">                  
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <center>
                            <a href="Controlador?accion=GenerarCompra" class="btn btn-primary btn-block"><i class="fas fa-cash-register"></i> Generar Compra</a>
                            <a href="#" data-toggle="modal" data-target="#myModalPago" class="btn btn-success btn-block"><i class="far fa-credit-card"></i> Realizar Pago</a>
                            </center>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="tab-pane fade" id="pills-registrar" role="tabpanel">
                                    <form action="Controlador">                               
                                        ...
                                        <div class="form-group">
                                            <label>Celular</label>
                                            <input type="number" name="txtdni" class="form-control" placeholder="7775996014">
                                        </div>
                                        <div class="form-group">
